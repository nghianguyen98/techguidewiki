...
export declare type SmartTerm = SmartTermItem[];
...
export declare type QueryTerm = QueryTermItem[];
 ...
 * - 2: Doc content
 */
export declare type SearchDocumentType = 0 | 1 | 2;
...
export declare type InitialSearchResult = SearchResultBase & Partial<SearchResultExtra>;
...
export declare type DocInfoType = 'docs' | 'blog' | 'page';
export declare type PluginConfig = Omit<PluginOptions, 'docsRouteBasePath' | 'blogRouteBasePath' | 'docsDir' | 'blogDir' | 'ignoreFiles'> & {
...
export declare type SearchSourceFn = (input: string, callback: (results: SearchResult[]) => void) => void;
export declare type SearchAnalyticsFn = (query: string, results?: SearchResult[]) => void;
