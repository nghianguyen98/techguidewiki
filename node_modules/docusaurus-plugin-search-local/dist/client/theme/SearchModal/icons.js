...
export function IconNoResults() {
    return (React.createElement("svg", { width: "40", height: "40", viewBox: "0 0 20 20", fill: "none", fillRule: "evenodd", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round" },
        React.createElement("path", { d: "M15.5 4.8c2 3 1.7 7-1 9.7h0l4.3 4.3-4.3-4.3a7.8 7.8 0 01-9.8 1m-2.2-2.2A7.8 7.8 0 0113.2 2.4M2 18L18 2" })));
}
export function IconTreeInter() {
    return (React.createElement("svg", { viewBox: "0 0 24 54" },
        React.createElement("g", { stroke: "currentColor", fill: "none", fillRule: "evenodd", strokeLinecap: "round", strokeLinejoin: "round" },
            React.createElement("path", { d: "M8 6v42M20 27H8.3" }))));
}
export function IconTreeLast() {
    return (React.createElement("svg", { viewBox: "0 0 24 54" },
        React.createElement("g", { stroke: "currentColor", fill: "none", fillRule: "evenodd", strokeLinecap: "round", strokeLinejoin: "round" },
            React.createElement("path", { d: "M8 6v21M20 27H8.3" }))));
}
